    ...
    return (
      <div className="min-h-screen bg-[#0a0f0a] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-4">Welcome to the Circle!</h1>
    ...
    return (
      <div className="min-h-screen bg-[#0a0f0a] flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-4">Invite Not Found</h1>
          <p className="text-[#8a9a8a] mb-8">
          ...
          <div className="space-y-3">
            <Link
              href="/circles"
              className="inline-block px-6 py-3 bg-[#22c55e] text-white rounded-xl font-medium hover:bg-green-600 transition-colors"
            >
              Browse Circles
            </Link>
            <div>
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-[#111a11] border border-[#1a2a1a] rounded-xl p-6">
          ...
          <div className="text-center mb-6">
            <div className="w-20 h-20 bg-[#22c55e] rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
              ⭕
            </div>
            <h2 className="text-xl font-bold text-white mb-2">{preview.name}</h2>
          ...
          {/* Invite Code Display */}
          <div className="bg-[#0a0f0a] border border-[#1a2a1a] rounded-lg p-3 mb-6 text-center">
          ...
          <button
            onClick={joinCircle}
            disabled={joining}
            className="w-full px-6 py-3 bg-[#22c55e] text-white rounded-xl font-bold hover:bg-green-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-4"
          >
            {joining ? (
          ...
          <div className="text-center">
            <Link
              href="/circles"
              className="text-[#8a9a8a] hover:text-white transition-colors text-sm"
            >
        ...
        {/* What happens next */}
        <div className="mt-8 bg-[#111a11] border border-[#1a2a1a] rounded-xl p-4">
